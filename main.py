...
def get_wikipedia_content(topic, lang='en'):
    user_agent = "MyWikipediaScraper/1.0 (contact: varunrao924@gmail.com)"
...
im = Image.open('images/wiki.png')
st.set_page_config(page_title="Wikipedia Q&A with DeepSeek",layout="wide",page_icon=im)
st.title("📖 Wikipedia Q&A with DeepSeek")
#to hide default right side menus
hide_default_format = """
       <style>
